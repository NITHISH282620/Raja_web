...
export const inventoryTiles: InventoryTile[] = [
  ...
  },
  {
    ...
    eyebrow: "Visuals",
    index: "08",
    title: "LED Fascia & Screens",
    body: "High-resolution modular LED walls for dynamic stage backdrops, live IMAG feeds, and digital branding across large venues.",
    image: {
  ...
  },
  {
    ...
    body: "Premium carpets, synthetic turf, and custom floor finishes to transform raw platforms into polished, event-ready environments.",
    image: {
