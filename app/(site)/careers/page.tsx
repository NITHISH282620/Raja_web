    ...
    <main id="main">
      ...
      <figure className="frame mt-[clamp(20px,3vw,44px)]">
        <div className="relative aspect-[21/9] w-full overflow-hidden rounded-[20px] bg-ink/5">
          <Image src={(await pageImage("careers-hero"))?.image ?? "/media/projects/14-09-gte2024-gte-the-biggest-garment-technology-shows-is-back-to-nsic-okhla-new-delhi.webp"} alt={(await pageImage("careers-hero"))?.alt ?? ""} fill priority sizes="(max-width: 1024px) 96vw, 1280px" className="object-cover" />
        </div>
