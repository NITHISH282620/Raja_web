    ...
    <main id="main">
      ...
      <figure className="frame mt-[clamp(20px,3vw,44px)]">
        <div className="relative aspect-[21/9] w-full overflow-hidden rounded-[20px] bg-ink/5">
          <Image src={(await pageImage("careers-hero"))?.image ?? "/media/projects/2x/fc-expo-2024.webp"} alt={(await pageImage("careers-hero"))?.alt ?? ""} fill priority sizes="(max-width: 1024px) 96vw, 1280px" className="object-cover" />
        </div>
