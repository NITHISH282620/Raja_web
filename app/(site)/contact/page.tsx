    ...
    <main id="main">
      ...
      <figure className="frame mt-[clamp(20px,3vw,44px)]">
        <div className="relative aspect-[21/9] w-full overflow-hidden rounded-[20px] bg-ink/5">
          <Image src={(await pageImage("contact-hero"))?.image ?? "/media/projects/2x/art-of-living-navaratri-2023.webp"} alt={(await pageImage("contact-hero"))?.alt ?? ""} fill priority sizes="(max-width: 1024px) 96vw, 1280px" className="object-cover" />
        </div>
